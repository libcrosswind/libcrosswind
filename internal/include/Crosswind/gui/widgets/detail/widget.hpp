...
namespace cw{
    ...
    class renderable_container: public renderable{
...
/*        on_attached += [this](std::shared_ptr<widget> element){ //We need to discuss this.

            element->set_absolute_width(this->get_width());
            element->set_absolute_height(this->get_height());
            element->set_absolute_depth(this->get_depth());
    ...
    class widget: public input_listener{
    public:
        widget(){
