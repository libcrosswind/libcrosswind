...
public:
	interpreter(): chai(new chaiscript::ChaiScript()){
		...
		chai->add(chaiscript::fun(&cw::interface::settings::window_settings::position), "position");
		chai->add(chaiscript::fun(&cw::interface::settings::window_settings::resolution), "resolution");
		chai->add(chaiscript::fun(&cw::interface::settings::window_settings::fps), "fps");
