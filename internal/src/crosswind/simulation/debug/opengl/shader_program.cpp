...
cw::simulation::debug::opengl::shader_program::shader_program(): 
attributes_number(0), 
program_id(0), 
vertex_shader_id(0), 
...
void cw::simulation::debug::opengl::shader_program::link(){
...
void cw::simulation::debug::opengl::shader_program::add_attribute(const std::string& attribute_name){
    glBindAttribLocation(program_id, attributes_number++, attribute_name.c_str());
}

int32_t cw::simulation::debug::opengl::shader_program::get_uniform_location(const std::string& uniform_name) {
...
void cw::simulation::debug::opengl::shader_program::use(){
...
void cw::simulation::debug::opengl::shader_program::unuse(){
    glUseProgram(0);
...
void cw::simulation::debug::opengl::shader_program::compile(const std::string& shader_filepath, 
